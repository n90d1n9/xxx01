...
class DayView extends ConsumerWidget {
          ...
          child: dayItems.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _buildAgendaCardWithReorderButtons(
                      context,
                      ref,
                      item,
                      index,
  ...
  Widget _buildAgendaCardWithReorderButtons(
    ...
    return Stack(
      children: [
        _buildAgendaCard(context, ref, item, key: ValueKey(item.id)),
        Positioned(
          right: 8,
          top: 8,
          child: Container(
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      _reorderItems(
                        context,
                        ref,
                        ref.read(filteredItemsProvider),
                        index,
                        index - 1,
                      );
                    },
