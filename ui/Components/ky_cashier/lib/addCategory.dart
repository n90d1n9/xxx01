...
class _AddCategoryState extends State<AddCategory> {
  ...
  performCategoryAddition() async {
    ...
    Map<String, dynamic> ret =
        await addCategoryAPI(context, _name!, _description!, widget.merchantId!);
    print(ret);
...
Future<Map<String, dynamic>> addCategoryAPI(BuildContext context, String name,
    String description, String merchantID) async {
  //String apiurl='https://jsonplaceholder.typicode.com/posts';
  //String apiurl= 'https://webapplication220190616025624.azurewebsites.net/Employee/AddEmployee/${merchantID}';
  String apiurl =
      'https://webapplication220190616025624.azurewebsites.net/Category/AddCategory/${merchantID}';
