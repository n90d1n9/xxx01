...
import 'package:kays_pos/ticketing_detail.dart';
...
class _AddProductState extends State<AddProduct> {
  ...
  performProductAddition() async {
    ...
    Map<String, dynamic> ret = await addProductAPI(
        context,
        _productName!,
        _unitCost!,
        _sellingPrice!,
                        ...
                        title: DropdownButton(
                          ...
                          onChanged: (valueSelectedHere) {
                            ...
                            //  _categorySelected = valueSelectedHere;
                              int index =
                                  categoryNames.indexOf(_categorySelected!);
...
Future<Map<String, dynamic>> addProductAPI(
  ...
  String apiurl =
      'https://webapplication220190616025624.azurewebsites.net/Product/AddProduct/${merchantID}';
  http.Response response = await http.post(Uri(host: apiurl),
      body: jsonEncode({
  ...
  if (response.statusCode == 200) {
    ...
    showDialogSingleButton(context, "Unable to Register",
        "Please try again or contact your support representative.", "OK");
  }
...
Future<List<dynamic>> getCategoryDetails(String merchantID) async {
  //String apiurl='https://jsonplaceholder.typicode.com/posts';
  String apiurl =
      'https://webapplication220190616025624.azurewebsites.net/Category/AllCategory/$merchantID';
  http.Response response = await http.get(Uri(host: apiurl), headers: {
    'Content-type': 'application/json',
    'Accept': 'application/json',
  });
  if (response.statusCode == 200) {
