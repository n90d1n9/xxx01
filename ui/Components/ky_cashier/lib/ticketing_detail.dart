...
import 'package:kays_pos/models/ticketJson.dart';
...
class TicketingDetail extends StatefulWidget {
  ...
  @override
  _TicketingDetailState createState() =>
      _TicketingDetailState(this.ticket!, this.title!);
}
...
class _TicketingDetailState extends State<TicketingDetail> {
  ...
  bool loading = true;
  static List<TicketJson> tickets = [];
  ...
  late TicketJson selectedTicketJson;
  void getAllProductDetails(String merchantID) async {
    //String apiurl='https://jsonplaceholder.typicode.com/posts';
    String apiurl =
        'https://webapplication220190616025624.azurewebsites.net/Product/AllProduct/$merchantID';
                    ...
                    : searchTextField = AutoCompleteTextField<TicketJson>(
                        ...
                        itemSubmitted: (item) {
                          ...
                          setState(() {
                            ...
                            ticket.subtotal =
                                selectedTicketJson.rate * quantity;
  ...
  void updateQuantityAsInt(int value) {
    if (value > 0) ticket.quantity = value;
  }
