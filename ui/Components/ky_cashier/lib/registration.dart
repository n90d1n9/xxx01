...
class _RegistrationState extends State<Registration> {
  ...
  performRegistration() async {
    ...
    Map<String, dynamic> ret = await registerAPI(context, _name!, _organisation!,
        _email!, _address!, _phone!, _username!, _password!);
    print(ret);
    if (ret != null) {
      setState(() {
...
Future<Map<String, dynamic>> registerAPI(
  ...
  String apiurl =
      'https://webapplication220190616025624.azurewebsites.net/Merchant/Merchant';
