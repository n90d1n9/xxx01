...
class _ReadBookPageState extends State<ReadBookPage>
  ...
  void initState() {
    ...
    colorTween1 = ColorTween(begin: Colors.black12, end: new Color(0xFF0018C8))
        .animate(new CurvedAnimation(
            parent: animationController!, curve: Curves.easeIn));
    colorTween2 =
        ColorTween(begin: Colors.transparent, end: new Color(0xFF001880))
            .animate(new CurvedAnimation(
                parent: animationController!, curve: Curves.easeIn));

    scrollController = new ScrollController();
    scrollController!.addListener(() {
      setState(() => readPerc = scrollController!.offset /
              ...
              new ListView(
                ...
                children: <Widget>[
                  new SizedBox.fromSize(
                    ...
                    /* child: new  Hero(
                      ...
                      child: Icon(Icons.account_circle,
                                              color: Colors.white, size: 48.0)//new Image.asset('res/img1.png', fit: BoxFit.cover),
                    ) */ 
                  ),
                  new Padding(
                  ...
                  new Padding(
                    ...
                    child: new /* Hero(
                      tag: 'Title',
                      child: new */ Text('Principles of Product Design',
                          textAlign: TextAlign.center,
                          style: new TextStyle(
                              fontSize: 40.0,
                              color: Colors.black,
                  ...
                  new Padding(
                    ...
                    child: new Text('By Aaron Walter',
                        textAlign: TextAlign.center,
                        style: new TextStyle(
                            fontSize: 14.0,
                            color: Colors.black,
