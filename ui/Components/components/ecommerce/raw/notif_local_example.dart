...
Future<void> main() async {
  ...
  String initialRoute = NotifHomepage.routeName;
  ...
  runApp(
    MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        NotifHomepage.routeName: (_) => NotifHomepage(notificationAppLaunchDetails),
...
class NotifHomepage extends StatefulWidget {
  ...
  @override
  _NotifHomepageState createState() => _NotifHomepageState();
}
...
Future<void> _showLinuxNotificationWithByteDataIcon() async {
  ...
  /* final image.Image? iconData = image.decodePng(
    assetIcon.buffer.asUint8List().toDart, //.toList(),
  ); */
