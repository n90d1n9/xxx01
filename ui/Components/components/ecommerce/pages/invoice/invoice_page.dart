    ...
    return Row(
      children: <Widget>[
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            Text("Juan Dela Cruz", style: textTheme!.bodySmall),
...
class ProjectBudget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: const Color(0xFFE7EAF5).withOpacity(0.6),
              ...
              child: Row(
                children: <Widget>[
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(12),
                      color: const Color(0xFF1E35F5).withOpacity(0.6),
                    ),
                    child: Text(
                      "98",
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Rank", style: textTheme!.bodySmall),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(
                          left: 8,
        ...
        Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Text("Projects", style: textTheme!.bodySmall),
            ),
            Padding(
              padding: const EdgeInsets.only(
                left: 8,
