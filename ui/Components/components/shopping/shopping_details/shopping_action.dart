...
import 'package:all_in_apps/widgets/common_divider.dart';
import 'package:all_in_apps/widgets/custom_float.dart';
        ...
        Row(
          ...
          children: <Widget>[
            CustomFloat(
              ...
              qrCallback: () => subtractionControllerAdd(true),
            ),
            StreamBuilder<int>(
              stream: getCount,
              initialData: 0,
            ...
            CustomFloat(
              ...
              qrCallback: () => additionalControllerAdd(true),
            ),
          ],
        )
      ],
...
additionalControllerAdd(bool bool) {
}

subtractionControllerAdd(bool bool) {
}
