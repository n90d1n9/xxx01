...
import 'package:syirkah/modules/register_modules.dart';
import 'package:url_launcher/url_launcher.dart';

//import '../common/image_picker/_image_picker_web.dart';
...
class ImageEditorDemo extends StatefulWidget {
  ...
  @override
  ImageEditorDemoState createState() => ImageEditorDemoState();
}

class ImageEditorDemoState extends State<ImageEditorDemo> {
 ...
 */
  ...
  Future<void> _pickImage() async {
    ...
    _memoryImage = await pickedFile!.readAsBytes();
