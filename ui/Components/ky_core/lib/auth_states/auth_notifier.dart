...
class AuthNotifier extends StateNotifier<AuthenticationState> {
  ...
  static const String _googleClientId = String.fromEnvironment(
    ...
    defaultValue: '483733451053-28afqa0qf1k6ac17jkr0kulocnbhtph6.apps.googleusercontent.com',
  );
  ...
  Future<void> _initGoogleSignIn() async {
    ...
    if (_isDesktop) {
      debugPrint('[GoogleSignIn] Skipping native initialization on desktop platform');
      return;
    }
