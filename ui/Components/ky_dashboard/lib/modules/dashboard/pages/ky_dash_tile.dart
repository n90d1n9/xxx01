  ...
  Widget build(BuildContext context)
  {
    ...
    (
      ...
      (
        ...
        title: const Text('Dashboard', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 30.0)),
        actions: <Widget>
        [
          Container
          (
                        ...
                        [
                          ...
                          (
                            ...
                            items: chartDropdownItems.map((String title)
                            {
                              ...
                              (
                                value: title,
                                child: Text(title, style: const TextStyle(color: Colors.blue, fontWeight: FontWeight.w400, fontSize: 14.0)),
                              );
                            }).toList()
                          )
                        ],
