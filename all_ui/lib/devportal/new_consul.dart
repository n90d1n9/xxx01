...
class AnalyticsTab extends StatelessWidget {
  ...
  const AnalyticsTab({super.key, required this.isDarkMode});

  List<FlSpot> _generateRandomSpots(int count, double minY, double maxY) {
    final random = Random();
    ...
    ProviderScope(
      child: MaterialApp(
        home: Scaffold(
          ...
          body: const DeveloperConsoleScreen(),
        ),
      ),
    ),
  );
