        ...
        state.map((room) {
          ...
          final updatedGroups =
              room.tableGroups.map((group) {
                ...
                final updatedTables =
                    group.tables.where((table) => table.id != tableId).toList();
                return group.copyWith(tables: updatedTables);
              }).toList();
                  ...
                  content: Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        items:
                            selectedRoom.tableGroups.map((group) {
                      ...
                      onPressed: () {
                        ...
                        if (name.isNotEmpty) {
                          final newTable = RestaurantTable(
                            ...
                            height:
                                double.tryParse(heightController.text) ?? 80,
                            shape: selectedShape,
                            capacity:
