          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor:
                    integration.isConnected ? Colors.red : Colors.blue,
              ),
      ...
      body: templatesAsync.when(
        data: (templates) {
          ...
          return ListView.builder(
            ...
            itemBuilder:
                (context, index) => TemplateCard(template: templates[index]),
          );
        },
        loading: () => const Center(child: CircularProgressIndicator()),
        error: (error, _) => Center(child: Text('Error: $error')),
            ...
            children: [
              TextButton(
                onPressed: () {
                  ...
                  ref.read(aiSuggestionsProvider.notifier).state =
                      current.where((s) => s.id != suggestion.id).toList();
                },
      ...
      body: workflowsAsync.when(
        data: (workflows) {
          ...
          return ListView.builder(
            ...
            itemBuilder:
                (context, index) => WorkflowCard(workflow: workflows[index]),
          );
        },
        loading: () => const Center(child: CircularProgressIndicator()),
        error: (error, _) => Center(child: Text('Error: $error')),
