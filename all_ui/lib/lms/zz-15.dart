            ...
            children: [
              ...
              Row(
                children: [
                  _buildInfoChip(
                    Icons.people,
                    '${university.totalStudents ~/ 1000}K mahasiswa',
                  ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: LinearProgressIndicator(
                        value:
                            week.totalMinutes / 1500, // Max 25 hours per week
                        minHeight: 8,
                        backgroundColor: Colors.grey[200],
...
final _mockUniversities = [
  University(
    ...
    logo: '🎓',
    description:
        'Universitas terkemuka di Indonesia dengan berbagai program studi unggulan',
...
final universitiesProvider = Provider<List<University>>(
  (ref) => _mockUniversities,
);
final personalTargetProvider = StateProvider<PersonalTarget>(
  (ref) => _mockPersonalTarget,
);
final achievementsProvider = StateProvider<List<Achievement>>(
  (ref) => _mockAchievements,
);
final studentLevelProvider = StateProvider<StudentLevel>(
  (ref) => _mockStudentLevel,
);
final analyticsProvider = Provider<PerformanceAnalytics>(
  (ref) => _mockAnalytics,
);
