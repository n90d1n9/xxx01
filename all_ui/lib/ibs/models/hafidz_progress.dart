...
class HafizProgress {
  ...
  final Surah
  surah; // Surah associated with the progress, manyToOne relationship
  final Teacher
  ...
  @override
  String toString() {
    return 'HafizProgress(id: $id, date: $date, startVerse: $startVerse, endVerse: $endVerse, comments: $comments, qualityScore: $qualityScore, memorizationStatus: $memorizationStatus, student: $student, surah: $surah, assessor: $assessor)';
  }
}
