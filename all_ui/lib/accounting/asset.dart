                      ...
                      Row(
                        children: [
                          IconButton(
                            ...
                            onPressed:
                                () => _navigateToEditAsset(context, asset),
                            tooltip: 'Edit',
                          ),
                          IconButton(
...
class _AssetFormViewState extends ConsumerState<AssetFormView> {
  ...
  Widget _buildPreview(BuildContext context) {
    final name =
        _nameController.text.isNotEmpty ? _nameController.text : 'Asset Name';
    ...
    final previewAsset = Asset(
      ...
      assetTag:
          _assetTagController.text.isEmpty ? null : _assetTagController.text,
    ...
    final depreciationPercent =
        purchaseValue > 0 ? (depreciationAmount / purchaseValue) * 100 : 0;
