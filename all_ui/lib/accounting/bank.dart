  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child:
            reconciliationState.transactions.isEmpty
...
class ReconciliationSummary extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final reconciledCount =
        reconciliationState.transactions
...
class ReconciliationTable extends ConsumerWidget {
            ...
            DataCell(
              matchedStatement != null
                  ? Text(
                    ...
                    style: TextStyle(
                      color:
                          matchedStatement.isDebit ? Colors.red : Colors.green,
                    ),
                  )
                  : const Text(''),
            ),
  ...
  void _showMatchDialog(
    ...
    final eligibleStatements =
        statements.where((s) => s.matchedTransactionId == null).toList();
