              ...
              ? FloatingActionButton(
                onPressed: () {
                  showDialog(
                    context: context,
                    builder:
                        (context) => AddTableDialog(floorId: currentFloor.id),
                  );
                },
      ...
      child: GestureDetector(
        ...
        onLongPress: () {
          showDialog(
            context: context,
            builder:
                (context) => EditTableDialog(floorId: floorId, table: table),
          );
        },
        child: Container(
          width: table.width,
...
class ReservationTable extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final tableStatus =
        isReserved ? TableStatus.reserved : TableStatus.available;
