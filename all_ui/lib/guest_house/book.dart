            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed:
                        selectedDates != null && !_isProcessing
                            ? _createBooking
                            : null,
                    child:
                        _isProcessing
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 16,
                color:
                    isDestructive ? Colors.red.shade700 : Colors.grey.shade700,
              ),
            ),
            const Spacer(),
            Icon(
              ...
              children:
                  recentBookings.map((booking) {
                    return FutureBuilder<Property>(
                      future: ref.read(
                        propertyProvider(booking.propertyId).future,
                      ),
