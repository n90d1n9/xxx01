...
import 'package:wayang_builder/features/workflow/components/node/model/schema/node_style.dart';

import 'features/workflow/model/workflow_node_port.dart';
import 'features/plugin/model/config_field.dart';
import 'features/workflow/components/node/model/schema/node_type_config.dart';
...
final Map<String, List<NodeConfig>> nodeTypesByCategory = {
  'Triggers': [
    NodeConfig(
      ...
      icon: Icons.webhook,
      style: NodeStyle(color: Colors.green),
      category: 'Triggers',
      inputs: [],
      outputs: [
    ...
    NodeConfig(
      ...
      icon: Icons.schedule,
      style: NodeStyle(color: Colors.green.shade700),
      category: 'Triggers',
      inputs: [],
  ...
  'AI/LLM': [
    NodeConfig(
      ...
      style: NodeStyle(color: Colors.purple),
      category: 'AI/LLM',
      inputs: [
    ...
    NodeConfig(
      ...
      icon: Icons.abc,
      style: NodeStyle(color: Colors.purple.shade700),
      category: 'AI/LLM',
  ...
  'Logic': [
    NodeConfig(
      ...
      style: NodeStyle(color: Colors.orange),
      category: 'Logic',
    ...
    NodeConfig(
      ...
      style: NodeStyle(color: Colors.orange.shade700),
      category: 'Logic',
      inputs: [PortConfig(id: 'input', label: 'Input', type: PortType.any)],
      outputs: [
  ...
  'Data': [
    NodeConfig(
      ...
      style: NodeStyle(color: Colors.blue),
      category: 'Data',
      inputs: [PortConfig(id: 'input', label: 'Input', type: PortType.any)],
    ...
    NodeConfig(
      ...
      style: NodeStyle(color: Colors.blue.shade700),
      category: 'Data',
  ...
  'Integration': [
    NodeConfig(
      ...
      icon: Icons.api,
      style: NodeStyle(color: Colors.teal),
    ...
    NodeConfig(
      ...
      icon: Icons.storage,
      style: NodeStyle(color: Colors.teal.shade700),
      category: 'Integration',
      inputs: [
        PortConfig(
          id: 'params',
  ...
  'Output': [
    NodeConfig(
      ...
      icon: Icons.output,
      style: NodeStyle(color: Colors.red),
      category: 'Output',
    ...
    NodeConfig(
      ...
      style: NodeStyle(color: Colors.red.shade700),
      category: 'Output',
      inputs: [
