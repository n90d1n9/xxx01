...
const String imageIcon = 'assets/icons/wayang-logo.png';

// constants.dart or inside workflow_utils.dart
const kNodeCardHeaderHeight = 40.0;
const kNodeCardInternalPadding = 12.0;
const kNodeCardPortSpacing = 30.0;
const kNodeCardWidth = 220.0;
