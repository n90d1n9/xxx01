                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        presentation.theme.primaryColor.withOpacity(0.9),
                        presentation.theme.secondaryColor.withOpacity(0.9),
                      ],
                    ),
        ...
        return ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: Container(
              decoration: BoxDecoration(
                color:
                    component.glassStyle?.tintColor.withOpacity(
                      component.glassStyle?.opacity ?? 0.2,
                    ) ??
      ...
      case VisualEffect.neon:
        return Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: (component.glowColor ?? Colors.blue).withOpacity(0.8),
                blurRadius: 30,
                spreadRadius: 10,
              ),
            ],
