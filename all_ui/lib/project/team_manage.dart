...
class WorkloadVisualizationTab extends ConsumerWidget {
  ...
  Widget _buildWorkloadSummaryCard(
    ...
    final overloadedCount =
        members.where((member) => member.workload > 80).length;
    final underutilizedCount =
        members.where((member) => member.workload < 40).length;
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                runSpacing: 8,
                children:
                    selectedRoleObj.permissions.map((permission) {
