...
class InventoryPage extends ConsumerWidget {
  ...
  Widget _buildInventoryTable(
    ...
    final filteredItems = selectedWarehouse != null
        ? inventoryItems
  ...
  void _showTransferStockDialog(
    ...
    final destinationWarehouses = warehouses
        .where((w) => w.id != sourceWarehouse.id)
        .toList();
              ...
              content: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: destinationWarehouses.map((warehouse) {
              ...
              actions: [
                ...
                TextButton(
                  onPressed: () {
                    ...
                    final destinationItemOpt = inventoryItems
                        .where(
                          (i) =>
