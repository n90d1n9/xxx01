...
class _HafizProgressScreenState extends ConsumerState<HafizProgressScreen>
      ...
      child: Column(
        ...
        children: [
          studentAsync.when(
            ...
            error: (error, _) =>
                Center(child: Text('Error loading student data')),
          ),
  ...
  Widget _buildProgressOverview(List<HafizProgress> progresses) {
    ...
    final avgQuality = progresses.isEmpty
        ? 0.0
                    ...
                    bottomTitles: AxisTitles(
                      sideTitles: SideTitles(
                        ...
                        getTitlesWidget: (value, meta) {
                          ...
                          final recentEntries = progresses.length > 5
          ...
          Expanded(
            child: progressesAsync.when(
              data: (progresses) {
                ...
                final sortedMonths = groupedProgresses.keys.toList()
                  ..sort((a, b) {
                                        ...
                                        Text(
                                          ...
                                          style: TextStyle(
                                            fontStyle:
                                                ...
                                                ? FontStyle.italic
                                                : FontStyle.normal,
                                            color: progress.comments!.isEmpty
                                                ? Colors.grey[500]
                                                : null,
                                          ),
                                        ),
...
Future<HafizProgress> createHafizProgress({
  ...
  final newId = existingProgresses.isNotEmpty
      ? existingProgresses.map((p) => p.id).reduce((a, b) => a > b ? a : b) + 1
      : 1;
