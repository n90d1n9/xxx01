...
class GanttStatusBar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final overallProgress = total == 0
        ? 0.0
        : tasks.map((t) => t.progress).reduce((a, b) => a + b) / total;
        ...
        children: [
          ...
          if (filter.isActive) ...[
            ...
            _StatusChip(
                ...
                label: '${visibleTasks.length}/${total} shown',
          ...
          if (multiSel.isNotEmpty) ...[
            ...
            _StatusChip(
                ...
                label: '${multiSel.length} selected',
          ...
          Text(
              '${GanttDateUtils.formatShortDate(start)} – ${GanttDateUtils.formatShortDate(end)}',
              style: const TextStyle(
                  fontFamily: 'Inter',
                  fontSize: 10,
                  color: GanttTheme.textDisabled)),
  ...
  Widget _dot() => Padding(
        ...
        child: Container(
            ...
            height: 2,
            decoration: const BoxDecoration(
                color: GanttTheme.surface4, shape: BoxShape.circle)),
      );
}
