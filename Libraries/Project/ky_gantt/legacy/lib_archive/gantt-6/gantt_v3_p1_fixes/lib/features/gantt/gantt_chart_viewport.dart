    ...
    showDialog(
      ...
      builder: (_) => _QuickCreateDialog(
        ...
        onCreate: (title) {
          ...
          if (trimmed.isEmpty)
            return; // silent guard - UI already shows placeholder
          ...
          ref
              ...
              .addTask(task); // validation result ignored: title pre-checked
        },
      ),
    );
  }
            ...
            Container(
              ...
              child: Text(
                ...
                style: const TextStyle(
                    fontSize: 9, color: GanttTheme.textSecondary),
              ),
            ),
        ]),
      ),
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        ...
                        Text(
                          ...
                          style: const TextStyle(
                              fontSize: 12, color: GanttTheme.textSecondary),
                        ),
                      ]),
                    ),
