    ...
    for (int i = 1; i <= 4; i++) {
      ...
      final tp = TextPainter(
          text: TextSpan(
              ...
              style: const TextStyle(fontSize: 8, color: GanttTheme.textMuted)),
              ...
              Expanded(
                  child: Text(
                      ...
                      style: const TextStyle(
                          fontSize: 11, color: GanttTheme.textSecondary))),
            ])),
      ]),
    );
  }
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Column(
            ...
            children: [
              ...
              Text(subtitle,
                  style: const TextStyle(
                      fontSize: 9, color: GanttTheme.textMuted)),
            ]),
      );
}
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          const Text('Less',
              style: TextStyle(fontSize: 9, color: GanttTheme.textMuted)),
...
class _EmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Center(
        ...
        const SizedBox(height: 8),
        Text(label,
            style: const TextStyle(fontSize: 12, color: GanttTheme.textMuted)),
      ]));
}
