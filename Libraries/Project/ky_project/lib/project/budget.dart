                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Wrap(
                                spacing: 16,
                                runSpacing: 8,
                                children: budgetData.map((category) {
                                  return Row(
              ...
              onPressed: () {
                if (amountController.text.isNotEmpty &&
                  ...
                  ref
                      ...
                      .addExpense(
                        Expense(
                          id: 'EXP${DateTime.now().millisecondsSinceEpoch.toString().substring(9)}',
                          category: category,
...
class CategoryBudgetChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PieChart(
      PieChartData(
        sections: budgetData.map((category) {
        ...
        barTouchData: BarTouchData(
          touchTooltipData: BarTouchTooltipData(
            ...
            getTooltipItem: (group, groupIndex, rod, rodIndex) {
              ...
              final amount = category.phases
                  .firstWhere((p) => p.phase == phase)
                  .amount;
...
class ContingencyWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final contingencyPercentage = (contingencyAmount / totalBudget * 100)
        .round();
    final formatter = NumberFormat.currency(symbol: '\$');
