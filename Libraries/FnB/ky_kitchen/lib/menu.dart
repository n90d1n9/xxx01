...
class _MenuManagementScreenState extends ConsumerState<MenuManagementScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final selectedMenu = menus.where((m) => m.id == selectedMenuId).isEmpty
        ? null
                  ...
                  .map(
                    (item) => Slidable(
                      ...
                      endActionPane: ActionPane(
                        ...
                        children: [
                          SlidableAction(
                            onPressed: (_) => _showEditMenuItemDialog(
                              selectedMenu.id,
                              category.id,
                              item,
                            ),
            ...
            ElevatedButton(
              onPressed: () {
                if (_menuNameController.text.isNotEmpty) {
                  ...
                  ref.read(menusProvider.notifier).updateMenu(updatedMenu);
                  Navigator.pop(context);
                }
              },
              ...
              onPressed: () {
                if (_itemNameController.text.isNotEmpty &&
                  ...
                  if (price != null) {
                    ...
                    ref
                        .read(menusProvider.notifier)
                        .updateMenuItem(menuId, categoryId, updatedItem);
                    Navigator.pop(context);
                  }
                }
              },
