...
import 'content_type_builder.dart';
import 'contents_type_provider.dart';
import 'model/content_type_schema.dart';
import 'screen/content_entries_page.dart';

class ContentTypeCard extends ConsumerWidget {
  final ContentTypeSchema contentType;
  const ContentTypeCard({super.key, required this.contentType});
  @override
