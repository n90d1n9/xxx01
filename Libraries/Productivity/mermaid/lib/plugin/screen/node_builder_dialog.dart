...
import '../widget/config_field_editor_dialog.dart';
import '../widget/http_request_editor.dart';
import '../widget/icon_picker_dialog.dart';
import '../widget/port_card.dart';
import '../widget/port_editor_dialog.dart';
import '../widget/script_action_editor.dart';
import '../widget/template_action_editor.dart';
import '../widget/transform_action_editor.dart';
import '../widget/workflow_action_editor.dart';
...
class _NodeBuilderDialogState extends ConsumerState<NodeBuilderDialog> {
  ...
  Widget _buildPortsTab(BuildContext context) {
    return ListView(
      padding: const EdgeInsets.all(24),
      children: [
        Row(
          children: [
            ...
            IconButton(
              ...
              onPressed: () => _addPort(true, context),
            ),
          ],
        ),
        ..._inputs.map(
        ...
        Row(
          children: [
            ...
            IconButton(
              ...
              onPressed: () => _addPort(false, context),
            ),
          ],
        ),
        ..._outputs.map(
      ...
      children: [
        Row(
          children: [
            ...
            IconButton(
              icon: const Icon(Icons.add, color: Colors.blue),
              onPressed: () => _addConfigField(context),
            ),
          ],
        ),
        ..._configFields.map((cf) => _buildConfigFieldCard(cf, context)),
        const SizedBox(height: 24),
        Row(
          children: [
            const Text(
        ...
        trailing: Row(
          ...
          children: [
            IconButton(
              ...
              onPressed: () => _editConfigField(field, context),
            ),
            IconButton(
  ...
  void _addPort(bool isInput, BuildContext context) {
    showDialog(
      context: context,
  ...
  void _addConfigField(BuildContext context) {
    showDialog(
      context: context,
  ...
  void _editConfigField(ConfigFieldDefinition field, BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => ConfigFieldEditorDialog(
        existingField: field,
  ...
  void _saveNode(BuildContext context) {
