...
class DayItemsList extends ConsumerWidget {
  final List<AgendaItem> dayItems;
  final GlobalKey reorderableKey;

  const DayItemsList({
    super.key,
    required this.dayItems,
    required this.reorderableKey,
  });
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return ReorderableListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return _buildAgendaCard(context, ref, item, key: ValueKey(item.id));
      },
    );
  }
