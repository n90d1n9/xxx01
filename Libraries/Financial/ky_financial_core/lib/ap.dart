...
class AccountsPayableScreen extends ConsumerWidget {
  ...
  Widget _buildInvoicesSection(BuildContext context, WidgetRef ref) {
    ...
    final currentFilter = ref.watch(filteredInvoicesProvider);
  ...
  Widget _buildFilterChip(
    ...
    return InkWell(
      onTap: () => ref.read(filteredInvoicesProvider.notifier).state = filter,
      child: Container(
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 24),
              _buildInvoiceDetailItem('Vendor', invoice.vendorName),
              ...
              _buildInvoiceDetailItem('Status', invoice.status.toUpperCase()),
              const SizedBox(height: 24),
