...
class _ClosingEntryScreenState extends ConsumerState<ClosingEntryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: screenWidth < 800 || _isAddingEntry
                          ...
                          DropdownButton<int>(
                            ...
                            onChanged: (int? newValue) {
                              if (newValue != null) {
                                ref
                                        .read(
                                          selectedFiscalYearProvider.notifier,
                                        )
                                        .state =
                                    newValue;
                              }
      ...
      child: screenWidth > 800
              ...
              children: [
                ...
                Expanded(
                  child: _buildSummaryCard('Quick Actions', [
                    _buildActionButton('New Journal Entry', Icons.post_add, () {
                      setState(() {
                        _isAddingEntry = true;
                        _isEditingEntry = false;
                      });
                    }),
                    _buildActionButton('Generate Report', Icons.summarize, () {
          ...
          : _buildSummaryCard('Current Period Summary', [
              ...
              Row(
                children: [
                  Expanded(
                    child: _buildActionButton('New Entry', Icons.post_add, () {
                      setState(() {
                        _isAddingEntry = true;
                        _isEditingEntry = false;
                      });
