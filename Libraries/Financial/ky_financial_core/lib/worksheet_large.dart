...
class EntryDetailPanel extends ConsumerWidget {
              ...
              children: [
                Expanded(
                  child: entry.debit > 0
                      ...
                      : const LabelValueRow(label: 'Debit Amount', value: '-'),
                ),
                Expanded(
                  child: entry.credit > 0
                      ...
                      : const LabelValueRow(label: 'Credit Amount', value: '-'),
                ),
              ],
            ),
  ...
  Widget _buildRelatedTransactions(BuildContext context, WidgetRef ref) {
    ...
    final relatedEntries = allEntries
        .where(
          (e) =>
              e.id != entry.id &&
...
class AnalyticsPanel extends ConsumerWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Divider(),
            Expanded(
              child: entriesByCategory.isEmpty
  ...
  Widget _buildCategoryAnalysis(
    ...
    final sortedEntries = entriesByCategory.entries.toList()
