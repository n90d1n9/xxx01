...
class FinancialStatementsScreen extends ConsumerWidget {
  ...
  Widget _buildSummarySection(
    ...
    final Color positiveColor = isDarkMode
        ? const Color(0xFF4ECCA3)
        : Colors.green.shade700;
    final Color negativeColor = isDarkMode
...
class EnhancedProfitAndLossStatementTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final positiveColor = isDarkMode
        ? const Color(0xFF4ECCA3)
        : Colors.green.shade700;
    final negativeColor = isDarkMode
        ? const Color(0xFFFF6B6B)
        : Colors.red.shade700;
...
class EnhancedBalanceSheetTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final borderColor = isDarkMode
        ? Colors.grey.shade800
        : Colors.grey.shade200;
    final assetColor = isDarkMode
        ? const Color(0xFF4ECCA3)
        : const Color(0xFF2E7D32);
    final liabilityColor = isDarkMode
        ? const Color(0xFFFF6B6B)
        : const Color(0xFFD32F2F);
    final equityColor = isDarkMode
        ? const Color(0xFF71C0F0)
...
class EnhancedCashFlowStatementTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final negativeColor = isDarkMode
        ? const Color(0xFFFF6B6B)
        : Colors.red.shade700;
    final operatingColor = isDarkMode
        ? const Color(0xFF4ECCA3)
        : const Color(0xFF2E7D32);
    final investingColor = isDarkMode
        ? const Color(0xFFFF6B6B)
        : const Color(0xFFD32F2F);
    final financingColor = isDarkMode
        ? const Color(0xFF71C0F0)
        : const Color(0xFF1976D2);
