            ...
            children: [
              ...
              _buildDetailRow(
                ...
                transaction.type == TransactionType.debit
                    ? Icons.arrow_upward_rounded
                    : Icons.arrow_downward_rounded,
                valueColor: transaction.type == TransactionType.debit
                    ? Colors.green.shade700
                    : Colors.red.shade700,
              ),
              _buildDetailRow(
                    ...
                    children: [
                      ...
                      TextField(
                        decoration: InputDecoration(
                          ...
                          suffixIcon: account != null && account!.isNotEmpty
                              ? IconButton(
                        ...
                        onChanged: (value) =>
                            account = value.isEmpty ? null : value,
                      ),
                      const SizedBox(height: 16),
                      TextField(
                        decoration: InputDecoration(
                          ...
                          suffixIcon: category != null && category!.isNotEmpty
                              ? IconButton(
                                  icon: const Icon(Icons.clear),
                                  onPressed: () =>
                                ...
                                children: [
                                  Icon(
                                    value == TransactionType.debit
                                        ? Icons.arrow_upward_rounded
                                        : Icons.arrow_downward_rounded,
                                    color: value == TransactionType.debit
                                        ? Colors.green
                                        : Colors.red,
                                    size: 18,
                                  ),
