                        ...
                        IconButton(
                          ...
                          onPressed: () =>
                              ref
                                  ...
                                  .state = (ref.read(zoomLevelProvider) - 0.1)
                                  .clamp(0.5, 2.0),
                        ),
          ...
          child: Row(
            children: [
              ...
              DropdownButton<PrinterFirmware>(
                ...
                items: PrinterFirmware.values.map((firmware) {
                  return DropdownMenuItem(
                    value: firmware,
  ...
  Widget _buildElementWidget(DesignElement element) {
    switch (element.type) {
      ...
      case ElementType.line:
        ...
        return Center(
          child: Container(height: thickness, color: Colors.black),
        );
...
class DesignStorageService {
  ...
  static PrinterDesign _designFromJson(Map<String, dynamic> json) {
    return PrinterDesign(
      ...
      elements: (json['elements'] as List).map((elementJson) {
        return DesignElement(
          id: elementJson['id'],
