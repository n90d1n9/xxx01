...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      //background: Color.fromARGB(0, 39, 85, 166),
      onBackground: background, // Color(0xff171c1f),
      surface: surface, // Color.fromARGB(255, 200, 220, 240),
      //surface: Color.fromARGB(255, 221, 230, 239),
      //surface: Color.fromARGB(255, 40, 86, 165),
      onSurface: background, // Color(0xff171c1f),
