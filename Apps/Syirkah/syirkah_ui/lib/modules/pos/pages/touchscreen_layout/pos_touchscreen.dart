...
class PosTouchLargePage extends ConsumerStatefulWidget {
  const PosTouchLargePage({super.key});

  @override
  ConsumerState<PosTouchLargePage> createState() => _PosGroceryPageState();
}

class _PosGroceryPageState extends ConsumerState<PosTouchLargePage> {
  @override
