...
class PosGroceryPage extends ConsumerStatefulWidget {
  const PosGroceryPage({super.key});

  @override
  ConsumerState<PosGroceryPage> createState() => _PosGroceryPageState();
}

class _PosGroceryPageState extends ConsumerState<PosGroceryPage> {
  @override
