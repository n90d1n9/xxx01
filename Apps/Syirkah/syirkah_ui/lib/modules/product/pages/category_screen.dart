...
class _CategoryScreenState extends State<CategoryScreen> {
  ...
  Widget _productList(Orientation orientation) {
    var _StairedGridTiles = _getStairedGridTiles(orientation);
    return Expanded(
      child: Container(
        decoration: BoxDecoration(
        ...
        StaggeredGridTile.count(
          StairedGridTileBuilder: (index) {
            return _StairedGridTiles[index];
          },
  ...
  List<StairedGridTile> _getStairedGridTiles(Orientation orientation) {
    return <StairedGridTile>[
      StairedGridTile(1, 1.5),
      StairedGridTile(1, 1.95),
      StairedGridTile(1, 1.8),
      StairedGridTile(1, 1.6),
      StairedGridTile(1, 1.5),
      StairedGridTile(1, 1.95),
      StairedGridTile(1, 1.8),
      StairedGridTile(1, 1.6),
