        ...
        return GestureDetector(
          ...
          child: Container(
            decoration: BoxDecoration(
              border: selectedItems.contains(name)
          ...
          children: [
            ...
            const Row(
              ...
              children: [
                ...
                MenuItem(
                    name: 'Dessert', imagePath: 'assets/images/dessert.png'),
              ],
            ),
            const SizedBox(height: 20),
            Expanded(
              child: GridView.count(
                ...
                children: const [
                  ...
                  MenuItem(
                      name: 'Es Teh Manis',
                      imagePath: 'assets/images/es_teh_manis.jpg'),
                  MenuItem(
                      name: 'Bubur Sumsum',
                      imagePath: 'assets/images/bubur_sumsum.jpg'),
                ],
              ),
            ),
            const SizedBox(height: 20),
