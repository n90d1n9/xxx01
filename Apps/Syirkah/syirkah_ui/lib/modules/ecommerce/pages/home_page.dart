...
import '../../finance/invoice/invoice_page.dart';
import '../../product/model/product_model.dart';
import '../../product/pages/product_screen.dart';
import '../utils/color_utils.dart';
import '../utils/dimens.dart';
import '../utils/images.dart';
import '../widgets/cream_small_text.dart';
import '../widgets/cream_title_text.dart';
import '../widgets/frosted_like_button.dart';
import '../widgets/frosted_lock_button.dart';
...
class ShopHomeScreenState extends State<ShopHomeScreen> {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SubTitleText(label: 'Alison Parker')
        ],
      ),
    );
  }
  ...
  Widget _collectionInfoText() {
    return Container(
      margin: const EdgeInsets.only(left: 15.0, top: 40),
      child: const Row(
        mainAxisAlignment: MainAxisAlignment.start,
        children: [
          const CreamTitleText(
  ...
  Widget _productItem(ProductModel productModel) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => const ProductScreen()));
      },
      child: Padding(
