        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              color: HexColor(display.highlightColor).withOpacity(0.8),
              child: Row(
...
class QueueStatusPanel extends StatelessWidget {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        queue.description,
                        style: TextStyle(
                          color: HexColor(display.textColor).withOpacity(0.7),
                          fontSize: 14,
                        ),
                      ),
                      const SizedBox(height: 16),
  ...
  Widget _buildInfoItem({
    ...
    return Row(
      children: [
        Icon(icon, color: HexColor(color).withOpacity(0.7), size: 18),
