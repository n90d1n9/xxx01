...
class CashFlowScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final cashFlowReport = ref.watch(cashFlowReportProvider);
        ...
        child: Column(
          ...
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSummaryRow(
                      'Total Income',
                      currencyFormat.format(cashFlowReport['totalIncome']),
                      Colors.green,
                    ),
                    const SizedBox(height: 8),
                    _buildSummaryRow(
                      'Total Expenses',
                      currencyFormat.format(cashFlowReport['totalExpense']),
                      Colors.red,
                    ),
                    const Divider(),
                    _buildSummaryRow(
                      'Net Cash Flow',
                      currencyFormat.format(cashFlowReport['netCashFlow']),
            ...
            _buildCategoryBreakdown(
              context,
              cashFlowReport['incomeByCategory']
                  as Map<TransactionCategory, double>,
              cashFlowReport['totalIncome'] as double,
              Colors.green,
              currencyFormat,
            ),
            const SizedBox(height: 24),
            ...
            _buildCategoryBreakdown(
              context,
              cashFlowReport['expenseByCategory']
                  as Map<TransactionCategory, double>,
              cashFlowReport['totalExpense'] as double,
              Colors.red,
              currencyFormat,
            ),
          ],
