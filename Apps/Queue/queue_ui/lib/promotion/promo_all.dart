      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip:
                state.isEnglish ? 'Switch to Indonesian' : 'Switch to English',
          ),
        ],
      ),
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child:
                  state.selectedPromotionType == null
                      ? _buildPromotionTypeGrid(context, state, notifier)
                      : PromotionForm(
                        promotionType: state.selectedPromotionType!,
                      ),
            ),
          ],
        ),
  ...
  void _showSavedPromotionDialog(BuildContext context, PromotionState state) {
    ...
    showDialog(
      ...
      builder:
          (context) => AlertDialog(
            title: Text(
              state.isEnglish ? 'Promotion Saved' : 'Promosi Tersimpan',
            ),
            content: Text(
              state.isEnglish
      ...
      child: Column(
        ...
        children: [
          ...
          TextFormField(
            ...
            maxLines: 3,
            onChanged:
                (value) => notifier.updateFormData({'description': value}),
          ),
          const SizedBox(height: 24),
        ...
        return Column(
          ...
          children: [
            TextFormField(
              decoration: InputDecoration(
                labelText:
                    isEnglish ? 'Discount Percentage' : 'Persentase Diskon',
                border: const OutlineInputBorder(),
        ...
        return Column(
          ...
          children: [
            TextFormField(
              ...
              onChanged:
                  (value) => notifier.updateFormData({'couponCode': value}),
            ),
            const SizedBox(height: 16),
            TextFormField(
              decoration: InputDecoration(
              ...
              keyboardType: TextInputType.number,
              onChanged:
                  (value) => notifier.updateFormData({'discountAmount': value}),
            ),
            const SizedBox(height: 16),
            DropdownButtonFormField<String>(
              ...
              onChanged:
                  (value) => notifier.updateFormData({'discountType': value}),
            ),
          ],
        );
        ...
        return Column(
          ...
          children: [
            TextFormField(
              decoration: InputDecoration(
                labelText:
                    isEnglish ? 'Points per Purchase' : 'Poin per Pembelian',
                border: const OutlineInputBorder(),
            ...
            TextFormField(
              decoration: InputDecoration(
                labelText:
                    isEnglish ? 'Points Redemption Value' : 'Nilai Tukar Poin',
                border: const OutlineInputBorder(),
        ...
        return Column(
          ...
          children: [
            DropdownButtonFormField<String>(
              decoration: InputDecoration(
                labelText:
                    isEnglish ? 'Buy X Get Y Type' : 'Tipe Beli X Dapat Y',
                border: const OutlineInputBorder(),
              ...
              onChanged:
                  (value) => notifier.updateFormData({'bogoType': value}),
            ),
            const SizedBox(height: 16),
            Row(
              children: [
