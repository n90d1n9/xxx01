...
class BillingDomainModuleReadinessBadge extends StatelessWidget {
  final BillingDomainModuleReadinessReport report;

  const BillingDomainModuleReadinessBadge({super.key, required this.report});
...
class BillingDomainModuleReadinessVisuals {
  ...
  const BillingDomainModuleReadinessVisuals({
  ...
  factory BillingDomainModuleReadinessVisuals.fromReport(
    BillingDomainModuleReadinessReport report,
  ) {
    if (!report.isReady) {
      return const BillingDomainModuleReadinessVisuals(
