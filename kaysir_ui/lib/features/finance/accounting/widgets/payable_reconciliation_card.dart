...
import 'payable_reconciliation_detail_dialog.dart';

class PayableReconciliationCard extends ConsumerWidget {
  const PayableReconciliationCard({super.key});
  ...
  void _showDetail(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => const PayableReconciliationDetailDialog(),
    );
  }
}
