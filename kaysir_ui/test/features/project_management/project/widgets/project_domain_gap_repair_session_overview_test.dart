...
import 'package:kaysir/features/project_management/project/widgets/project_domain_gap_repair_session_overview.dart';

void main() {
  testWidgets('repair session overview composes guidance and repair steps', (
    tester,
  ) async {
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: ProjectDomainGapRepairSessionOverview(
    ...
    expect(find.text('Guided: 2 steps'), findsOneWidget);
...
ProjectTableCustomColumn _column({
  ...
  ProjectCustomAttributeType type = ProjectCustomAttributeType.text,
}) {
